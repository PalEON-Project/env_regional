...
soil.path <- "~/Desktop/Research/PalEON_CR/env_regional/env_drivers_raw/soil/NACP_MSTMIP_MODEL_DRIVER/data/mstmip_driver_na_qd_soil_v1.nc4"
soil.out <- "~/Desktop/Research/PalEON_CR/env_regional/env_paleon/soil"
